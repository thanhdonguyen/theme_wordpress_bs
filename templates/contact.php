...
?>
  ...
  <style>
    #contact{
      background-color: <?php echo get_theme_mod('contact_backgroud'); ?>;
      color: <?php echo get_theme_mod('contact_color'); ?>;
    }
    hr.star-primary{
      border-color: <?php echo get_theme_mod('contact_color'); ?>;
    }
    hr.star-primary:after{
      ...
      <div class="container">
        <h2 class="text-center"><?php echo get_theme_mod('contact_heading'); ?></h2>
